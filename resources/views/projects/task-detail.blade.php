                ...
                <div class="bg-white border border-slate-200 rounded-lg overflow-hidden shadow-sm">
                    <table class="w-full divide-y divide-slate-200">
                        ...
                        <tbody class="bg-white divide-y divide-slate-100">
                            <template x-for="week in planWeeks" :key="week.id">
                                <tr class="hover:bg-slate-50 transition-colors">
                                    <td class="px-4 py-2.5 text-sm font-medium text-slate-700" x-text="'W' + week.week_number"></td>
    ...
    document.addEventListener('alpine:init', () => {
        Alpine.data('taskDetail', () => ({
            ...
            addRabRow() {
                ...
                this.task.task_items.push({ master_item_id: '', qty: 1, harga_satuan: 0, modal_satuan: 0 });
            },
